...
class WaitingList extends Component
{
    ...
    public function uploadFoto($id)
    {
        ...
        Storage::delete('public/service/waitinglist/'.$report->foto_after);
        $file->storeAs('public/service/waitinglist/', $nama_file);
    ...
    {
        $total = WaitModel::where('kategori', 'Service')->count();
