...
class ReportHarianNew extends Component
{
    ...
    public function render()
    {
        $query = HarianModel::query()
            ->leftJoin('kategori_harian_news', 'report_harian_it_news.kategori_harian_id', '=', 'kategori_harian_news.id')
            ->leftJoin('users', 'report_harian_it_news.user_id', '=', 'users.id')
            ->select('report_harian_it_news.*');
        ...
        return view('livewire.it.report-harian-new', $data);
    }
}
