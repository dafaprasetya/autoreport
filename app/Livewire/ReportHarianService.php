...
class ReportHarianService extends Component
{
    protected $listeners = [
    ...
    public function render()
    {
        $query = HarianModel::query()
            ->leftJoin('kategori_harians', 'report_harian_services.kategori_harian_id', '=', 'kategori_harians.id')
            ->leftJoin('users', 'report_harian_services.user_id', '=', 'users.id')
            ->select('report_harian_services.*');
        ...
        return view('livewire.report-harian-service', $data);
    }
}
