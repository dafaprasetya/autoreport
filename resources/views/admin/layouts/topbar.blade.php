                ...
                <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                    <a href="" class="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-sm text-secondary-light text-w-200-px">Ada pesan yang belum dibaca dan ditanggapi</p>
                        </div>
                        </div>
            ...
            <div class="dropdown-menu to-top dropdown-menu-sm">
              <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                <div>
                  ...
                  <span class="text-secondary-light fw-medium text-sm">{{ Auth::user()->bagian }}</span>
                </div>
