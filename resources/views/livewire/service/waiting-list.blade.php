<div wire:poll>
    ...
    <div class="table-responsive">
        <table class="table bordered-table mb-0">
            ...
            <tbody>
                @livewire('Service.FormWaitingList')
                    ...
                    <td class="text-center">
                        ...
                        @if ($waitings->foto_keluhan)
                            ...
                            <div class="mt-1" style="cursor: pointer;" onclick="document.getElementById('foto_keluhan{{ $waitings->id }}').click()">
                                ...
                                @else
                                    <img src="{{ asset('storage/service/waitinglist/'.$waitings->foto_keluhan) }}" alt="Uploaded" class="img-thumbnail" style="max-height: 100px;">
                                @endif
                            </div>
                        @endif
                    </td>
