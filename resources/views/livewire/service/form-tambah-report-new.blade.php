<div class="row">
    <div class="col-lg-12">
        @if ($eksekutors)
            <div class="row">
                <div class="col-md-12 mt-2">
                    <div class="form-group">
                        <label class="form-label" for="tanggal">Target Selesai</label>
                        <input class="form-control" type="date" wire:model="target_selesai">
                        <div>
            ...
            <div class="col-md-12 mt-2">
                <div class="form-group">
                    <label class="form-label" for="detail_kerja">Note Progres</label>
                    <textarea rows="1" class="form-control" wire:model="note_progres" placeholder="Masukan Note Progres"></textarea>
                    <div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-2">
                    <div class="form-group" wire:ignore>
                        ...
                        <select wire:model.defer="kategori_harian_id" class="katharian" id="kategori_harian">
                ...
                <div class="col-md-6 mt-2">
                    <div class="form-group" wire:ignore>
                        ...
                        <select class="keterangan" wire:model="keterangan">
                ...
                <div class="col-md-6 mt-2">
                    <div class="form-group" wire:ignore>
                        ...
                        <select class="users" wire:model="user_id">
                ...
                <div class="col-md-6 mt-2">
                    <div class="form-group" wire:ignore>
                        ...
                        <select class="jenis" wire:model="jenis_pekerjaan_id">
                ...
                <div class="col-md-12 mt-2">
                    <div class="form-group" wire:ignore>
                        <div class="form-label">Status</div>
                        <select class="status" wire:model="status">
                            <option value="">-- Pilih STATUS --</option>
                            <option value="Selesai">Selesai</option>
                            <option value="Belum Selesai">Belum Selesai</option>
                        </select>
    ...
    <div class="col-lg-12 mt-3" wire:poll>
        <div class="text-center">MASTER GA</div>
            ...
            <table class="table bordered-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th scope="col">User/Pelakasana</th>
                        <th scope="col">Detail Kerja</th>
                        <th scope="col">Status</th>
                        <th scope="col">Note Progress</th>
                        <th scope="col">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="date" value="{{ $reports->tanggal_penugasan }}" wire:blur="updateCell({{ $reports->id }}, 'tanggal_penugasan', $event.target.value)">
                        </td>
                        <td>
                            <input class="form-control" type="date" value="{{ $reports->target_selesai }}" wire:blur="updateCell({{ $reports->id }}, 'target_selesai', $event.target.value)">
                        </td>
                        <td>
                        ...
                        <td>
                            <textarea wire:blur="updateCell({{ $reports->id }}, 'note_progres', $event.target.value)" cols="30" class="form-control" rows="2">{{ $reports->note_progres }}</textarea>
                        </td>
                        <td>
